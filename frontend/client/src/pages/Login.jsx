          ...
          {requiresPasswordChange ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 rounded-md bg-card border border-border px-3 py-2 text-[13px] font-medium transition-colors hover:bg-secondary text-foreground shadow-sm shadow-black/[0.02]"
              >
